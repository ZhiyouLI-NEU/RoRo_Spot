...
For example: "S1_1_Small_11_8" refers to the first instance in set S1, which is configured with a small-sized ship, 11 transportation orders. In the instance, 8 transportation orders are spot orders.
